package com.example.trafficscotlandapp.ui.currentincident
...
import kotlinx.android.synthetic.main.fragment_current_incidents.*
import kotlinx.android.synthetic.main.fragment_current_incidents.view.*
...
class CurrentIncidentsFragment : Fragment() {
    ...
    private val accidentList = ArrayList<CurrentIncidents>()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_current_incidents, container, false)

        view.currentIncidentRecyclerView.layoutManager = LinearLayoutManager(requireContext())
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                if(accidentList!=null) {
                    currentIncidentProgressBar.visibility = View.INVISIBLE
                    setAdapterValues()
                }
            }
        })
    ...
    private fun setAdapterValues() {
        ...
        activity?.runOnUiThread {
            ...
            requireView().currentIncidentRecyclerView.adapter = adapter
        }
    }
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                when (eventType) {
                    ...
                    XmlPullParser.END_TAG -> if (tagName.equals("item", ignoreCase = true)) {
                        foundItem = false
                        accidentList.add(CurrentIncidents(titleTxt,descriptionTxt,pubDateTxt, latLongTxt,linkTxt))
