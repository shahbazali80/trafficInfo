package com.example.trafficscotlandapp.ui.roadworks
...
import kotlinx.android.synthetic.main.fragment_roadworks.*
import kotlinx.android.synthetic.main.fragment_roadworks.view.*
...
class RoadworksFragment : Fragment() {

    var client = OkHttpClient()
    private var url = "https://trafficscotland.org/rss/feeds/roadworks.aspx"
    var myResponse = ""
    ...
    val roadWorksList = ArrayList<CurrentIncidents>()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_roadworks, container, false)

        view.roadworksRecyclerview.layoutManager = LinearLayoutManager(requireContext())
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                if(roadWorksList!=null) {
                    roadworksProgressBar.visibility = View.INVISIBLE
                    setAdapterValues()
                }
            }
        })
    ...
    private fun setAdapterValues() {
        ...
        activity?.runOnUiThread {
            val adapter = TrafficInfoAdapter(roadWorksList)
            requireView().roadworksRecyclerview.adapter = adapter
        }
    }
